...
official/supported Docker Images found at https://hub.docker.com/r/SmartiesCoin/Smartiecoind/
...
**NOTE: Please update the image description at https://hub.docker.com/r/SmartiesCoin/Smartiecoind-develop/ when changing the above text**
