...
static OutputDescription CreateDummyOD()
{
    ...
    dummyOD.cv = Uint256Max();
    dummyOD.cmu = Uint256Max();
    dummyOD.ephemeralKey = Uint256Max();
...
static SpendDescription CreateDummySD()
{
    ...
    dummySD.cv = Uint256Max();
    dummySD.anchor = Uint256Max();
    dummySD.nullifier = Uint256Max();
    dummySD.rk = Uint256Max();
