# Smartiecoin Core version v22.1.0
...
Version 2 of the Smartiecoin P2P protocol / BIP324, which enables encryption of the P2P protocol,
has been enabled by default in this version. This was initially introduced in Smartiecoin Core
...
You can view [the list of bad ports here](https://github.com/SmartiesCoin/Smartiecoin/blob/v22.1.x/doc/p2p-bad-ports.md).

Tests
-----

- Command line arguments `-dip8params` and `-bip147height` are removed in favor of `-testactivationheight`. (smartiecoin#6325)
...
- The top-level fee fields `fee`, `modifiedfee`, `ancestorfees` and `descendantfees`
  ...
  fields in the `fees` object are denominated in SMT.
...
- Improved GUI responsiveness for large wallets. (smartiecoin#6457)
...
[set-of-changes]: https://github.com/SmartiesCoin/Smartiecoin/compare/v22.0.0...dashpay:v22.1.0
