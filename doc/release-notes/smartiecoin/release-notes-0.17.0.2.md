Smartiecoin Core version 0.17.0.2
==========================
...
from other quorum members. This allows Smartiecoin Platform to obtain required
...
Platform support
----------------
Support for Smartiecoin Platform has been expanded through the addition of a new
...
BLS update
----------
Smartiecoin Core’s BLS signature library has been updated based on v1.0 of the
...
--------------------------------
This version of Smartiecoin Core includes multiple optimizations to the network and
...
Statoshi backport
------------------
This version includes a [backport](https://github.com/SmartiesCoin/Smartiecoin/pull/2515)
...
RPC changes
-----------
There are seven new RPC commands which are Smartiecoin specific and seven new RPC
...
Smartiecoin users. Bitcoin changes that do not align with Smartiecoin’s product needs, such
...
See detailed [set of changes](https://github.com/SmartiesCoin/Smartiecoin/compare/v0.16.1.1...dashpay:v0.17.0.2).
