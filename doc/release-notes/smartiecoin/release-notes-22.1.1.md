# Smartiecoin Core version v22.1.1
...
This version addressed a problem affecting certain Smartiecoin-specific connection types, including mixing and masternode probes, when
downgrading from v2 to v1 connections. This resulted in increased connection count and load for masternodes. (smartiecoin#6574)

Minor QT Coinjoin Fixes
-----------------------

- Avoid leaking CJ related balances in discrete mode (smartiecoin#6566)
...
[set-of-changes]: https://github.com/SmartiesCoin/Smartiecoin/compare/v22.1.0...dashpay:v22.1.1
