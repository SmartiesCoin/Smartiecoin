# Smartiecoin Core version v19.3.0
...
- `wipetxes`: New command for `smartiecoin-wallet` that removes all wallet transactions
...
See detailed [set of changes](https://github.com/SmartiesCoin/Smartiecoin/compare/v19.2.0...dashpay:v19.3.0).
