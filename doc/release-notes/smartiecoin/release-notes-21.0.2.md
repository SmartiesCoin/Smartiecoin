# Smartiecoin Core version v21.0.2
...
Resolved a bug that prevented some clients (incl. Smartiecoin mobile wallets) from receiving transactions before they are mined
...
The [docker images](https://hub.docker.com/r/SmartiesCoin/Smartiecoind) should now provide SBOM and provenance.
...
[set-of-changes]: https://github.com/SmartiesCoin/Smartiecoin/compare/v21.0.0...dashpay:v21.0.2
