# Smartiecoin Core version v19.2.0
...
At the first startup Smartiecoin Core will run a migration process which can take
...
incompatible with older versions of Smartiecoin Core, so a db migration path was
...
See detailed [set of changes](https://github.com/SmartiesCoin/Smartiecoin/compare/v19.1.0...dashpay:v19.2.0).
