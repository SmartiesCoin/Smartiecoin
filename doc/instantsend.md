...
This mechanism has been integrated into Bitcore-Node-Smartiecoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/dashpay/insight-api-smartiecoin#web-socket-api](https://github.com/dashpay/insight-api-smartiecoin#web-socket-api)
* API: [https://github.com/dashpay/insight-api-smartiecoin#instantsend-transactions](https://github.com/dashpay/insight-api-smartiecoin#instantsend-transactions)
