# Support for Output Descriptors in Smartiecoin Core

Since Smartiecoin Core v0.17, there is support for Output Descriptors. This is a
...
existing Smartiecoin Core wallets, a convenience function `combo` is
...
All RPCs in Smartiecoin Core will include the checksum in their output. Only
