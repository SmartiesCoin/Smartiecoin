...
class RawTransactionsTest(BitcoinTestFramework):
    ...
    def createrawtransaction_tests(self):
        ...
        assert_raises_rpc_error(-5, "Invalid Smartiecoin address", self.nodes[0].createrawtransaction, [], {'foo': 0})
    ...
    def sendrawtransaction_testmempoolaccept_tests(self):
        ...
        # Fee rate is 0.00500000 SMT/kvB
        ...
        # Fee rate is 0.20000000 SMT/kvB
