...
class HelpRpcTest(BitcoinTestFramework):
    ...
    def test_categories(self):
        ...
        # wrong argument count, note: Smartiecoin's help allows for two options since we utilize subcommands
        ...
        components = ['Addressindex', 'Blockchain', 'Control', 'Smartiecoin', 'Evo', 'Mining', 'Network', 'Rawtransactions', 'Util']
